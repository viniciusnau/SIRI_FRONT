...
@Component({
  selector: 'edit-protocols-modal',
  templateUrl: 'edit-protocols-modal.component.html',
  styleUrls: ['./edit-protocols-modal.component.scss'],
})
export class EditProtocolsModalComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<EditProtocolsModalComponent>,
