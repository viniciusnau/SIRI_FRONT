...
export interface CreateAccountantReportsModalData {
  suppliers: Supplier[];
}

@Component({
  selector: 'create-accountant-reports-modal',
  templateUrl: 'create-accountant-reports-modal.component.html',
  styleUrls: ['./create-accountant-reports-modal.component.scss'],
...
export class AccountantReportsModalComponent implements OnInit {
  ...
  constructor(
    ...
    @Inject(MAT_DIALOG_DATA) public data: CreateAccountantReportsModalData,
